...
function FitImg(props: {src: string, className?: string, fitTo: RefObject<HTMLDivElement|null>}): ReactElement {
    ...
    function updateSize(retriggerCount: number) {
        if (!props.fitTo.current) { return; }
        if (!imgRef.current) { return; }
        
        const targetHeight = props.fitTo.current.clientHeight;        
        ...
        if (retriggerCount) { updateSize(retriggerCount-1); }
    }
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <div className="flex landscape:flex-row portrait:flex-col-reverse gap-5" ref={ section1Ref }>
                    ...
                    <div className="flex landscape:flex-row portrait:flex-col gap-5">
                        <div className="border-1 p-2 font-mono landscape:wrap-none mobile:wrap bg-black">
                            ...
                            <ul className="p-1 text-white">
                                <li>• Automatic downloading of YouTube videos</li>
                                <li>• f2</li>
                                <li>• f3</li>
                                <li>• f4</li>
                                <li>• f5</li>
                        ...
                        <div className="border-1 p-2 font-mono flex-1 flex flex-col gap-2">
                            <h2 className="font-bold">Synchronisation</h2>
                            <p className="text-s pl-4 pr-4 indent-4">
                                body-sync-1
                            </p>
                        </div>
                ...
                <FitImg fitTo={section1Ref} src="/assets-capstone/screen-1.webp" className='w-min h-min border-1 p-3 box-border' />
            </div>

            <div className="flex landscape:flex-row portrait:flex-col gap-5">
                <FitImg fitTo={section2Ref} src="/assets-capstone/screen-1.webp" className='w-min h-min border-1 p-3 box-border' />
